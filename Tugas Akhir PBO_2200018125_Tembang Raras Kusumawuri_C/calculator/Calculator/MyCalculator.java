...
String operatorButtonText[] = {"/", "sqrt", "X", "%", "-", "1/X", "+", "=" };
...
final int HEIGHT=40, WIDTH=50, H_SPACE=15,V_SPACE=30;
...
memoryButton[i].setForeground(Color.DARK_GRAY);
y+=HEIGHT+V_SPACE;
}
...
{
new MyCalculator("Kalkulator Rara - UAD");
}
}
